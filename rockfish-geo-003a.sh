...
/local/cluster/stacks/stacks-1.47/bin/denovo_map.pl -T 15 -X "ustacks:-m 2 -M 2 --model_type bounded --bound_high 0.05" -X "cstacks:-n 1" -b 18 -D rockfish-geo-003 -S \
-o /nfs1/FW_HMSC/OMalley_Lab/vauxf/STACKS/stacks_out/rockfish/geo-003 \
